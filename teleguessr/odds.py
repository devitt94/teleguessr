...
BOOKMAKER_LADDER: tuple[tuple[float, FractionalOdds | None]] = (
    ...
    (0.825, FractionalOdds(1, 7)),
    (0.815, FractionalOdds(2, 13)),
    (0.805, FractionalOdds(1, 6)),
    (0.795, FractionalOdds(2, 11)),
    (0.78, FractionalOdds(1, 5)),
    (0.765, FractionalOdds(2, 9)),
    (0.75, FractionalOdds(1, 4)),
    (0.735, FractionalOdds(4, 15)),
    (0.725, FractionalOdds(2, 7)),
    (0.715, FractionalOdds(3, 10)),
    (0.705, FractionalOdds(1, 3)),
    (0.695, FractionalOdds(7, 20)),
    (0.685, FractionalOdds(4, 11)),
    (0.675, FractionalOdds(3, 8)),
    (0.6575, FractionalOdds(2, 5)),
    (0.64, FractionalOdds(4, 9)),
    (0.625, FractionalOdds(7, 15)),
    (0.61, FractionalOdds(1, 2)),
    (0.595, FractionalOdds(8, 15)),
    (0.58, FractionalOdds(4, 7)),
    (0.565, FractionalOdds(8, 13)),
    (0.545, FractionalOdds(4, 6)),
    (0.535, FractionalOdds(7, 10)),
    (0.5225, FractionalOdds(8, 11)),
    (0.505, FractionalOdds(4, 5)),
    (0.49, FractionalOdds(5, 6)),
    (0.47, FractionalOdds(10, 11)),
    (0.46, FractionalOdds(20, 21)),
    (0.445, FractionalOdds(1, 1)),
    (0.4325, FractionalOdds(21, 20)),
    ...
    (0.345, FractionalOdds(6, 4)),
    (0.325, FractionalOdds(13, 8)),
    (0.31, FractionalOdds(7, 4)),
    (0.295, FractionalOdds(15, 8)),
    (0.2825, FractionalOdds(2, 1)),
    (0.27, FractionalOdds(21, 10)),
    (0.26, FractionalOdds(11, 5)),
    (0.2525, FractionalOdds(9, 4)),
    (0.24, FractionalOdds(12, 5)),
    (0.23, FractionalOdds(5, 2)),
    (0.21, FractionalOdds(11, 4)),
    (0.195, FractionalOdds(3, 1)),
    (0.18, FractionalOdds(13, 4)),
    (0.17, FractionalOdds(7, 2)),
    (0.16, FractionalOdds(15, 4)),
    (0.15, FractionalOdds(4, 1)),
    (0.14, FractionalOdds(17, 4)),
    (0.1325, FractionalOdds(9, 2)),
    (0.125, FractionalOdds(19, 4)),
